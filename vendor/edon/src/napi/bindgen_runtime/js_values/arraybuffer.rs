...
macro_rules! impl_typed_array {
    ($name:ident, $rust_type:ident, $typed_array_type:expr) => {
        ...
        impl $name {
            ...
            pub fn sync(&mut self, env: &crate::napi::Env) {
                if let Some((reference, _)) = self.raw {
                    ...
                    crate::napi::check_status_or_throw!(
                        env.raw(),
                        unsafe {
                            libnode_sys::napi_get_reference_value(env.raw(), reference, &mut value)
                        },
        ...
        impl ToNapiValue for $name {
            unsafe fn to_napi_value(
                ...
                if let Some((ref_, _)) = val.raw {
                    ...
                    check_status!(
                        unsafe {
                            libnode_sys::napi_get_reference_value(env, ref_, &mut napi_value)
                        },
