...
impl<T: 'static> FromNapiValue for External<T> {
    unsafe fn from_napi_value(
        ...
        check_status!(
            unsafe {
                libnode_sys::napi_get_value_external(env, napi_val, &mut unknown_tagged_object)
            },
...
impl<T: 'static> ToNapiValue for External<T> {
    unsafe fn to_napi_value(
        ...
        {
            let mut adjusted_external_memory_size = 0i64;
                ...
                check_status!(
                    unsafe {
                        libnode_sys::napi_adjust_external_memory(
                            ...
                            &mut adjusted_external_memory_size,
                        )
                    },
