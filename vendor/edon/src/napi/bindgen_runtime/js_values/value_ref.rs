...
impl<T: 'static> Reference<T> {
    ...
    pub fn add_ref(env: libnode_sys::napi_env, t: *mut c_void, value: RefInformation) {
    ...
    #[doc(hidden)]
    pub unsafe fn from_value_ptr(t: *mut c_void, env: libnode_sys::napi_env) -> Result<Self> {
